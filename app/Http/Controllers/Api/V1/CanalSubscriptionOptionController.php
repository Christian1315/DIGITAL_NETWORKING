...
class CanalSubscriptionOptionController extends CANAL_SUBSCRIPTION_OPTION_HELPER
{
    ...
    #GET A OPTION 
    function RetrieveOption(Request $request, $id)
    {
        #VERIFICATION DE LA METHOD
        if ($this->methodValidation($request->method(), "GET") == False) {
            #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
        ...
        return $this->_subscriptionOption($id);
    }
}
